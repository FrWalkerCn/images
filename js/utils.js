    ...
    if (rm.downloadimging == false) {
      ...
      setTimeout(function () {
        ...
        image.onload = function () {
          ...
          context.fillStyle = "rgba(251, 5, 5,0.5)";  // 设置颜色和透明度
          context.textAlign = "center";  // 设置文本对齐方式
          context.textBaseline = "middle";  // 设置文本基线
          context.fillText("frwalker.top", canvas.width / 2, canvas.height / 2);  // 在中心位置添加水印文本
          context.fillText("frwalker.top", canvas.width - context.measureText("frwalker.top").width / 2 - 10, canvas.height - 25);
